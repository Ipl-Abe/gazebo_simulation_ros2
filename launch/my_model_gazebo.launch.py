...
def generate_launch_description():
    ...
    robot_xacro_file = os.path.join(mycobot_description_share_path, 'urdf', 'mycobot_280_m5.urdf')
    ...
    gzserver = IncludeLaunchDescription(
        ...
        # launch_arguments={'world': os.path.joint()gazebo_share_directory, 'world',}
    )
